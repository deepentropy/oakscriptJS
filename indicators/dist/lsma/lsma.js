...
var metadata = { title: "Least Squares Moving Average", shortTitle: "LSMA", overlay: true };
var inputConfig = [{ id: "length", type: "int", title: "Length", defval: 25 }, { id: "offset", type: "int", title: "Offset", defval: 0 }, { id: "src", type: "source", title: "Source", defval: "close" }];
var plotConfig = [{ id: "plot0", title: "lsma", color: "#2962FF", lineWidth: 2 }];
var calculate = Least_Squares_Moving_Average;
export {
  Least_Squares_Moving_Average,
  Least_Squares_Moving_Average as Least_Squares_Moving_AverageIndicator,
  calculate,
  defaultInputs,
  inputConfig,
  metadata,
